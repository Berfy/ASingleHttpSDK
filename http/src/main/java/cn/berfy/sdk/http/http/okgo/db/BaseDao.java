 ...
 */
package cn.berfy.sdk.http.http.okgo.db;
...
public abstract class BaseDao<T> {
    ...
    public boolean insert(T t) {
        ...
        try {
            ...
            HLogF.printStackTrace(e);
        } finally {
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " insertT");
        }
        return false;
    }
    ...
    public boolean insert(List<T> ts) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " insertList");
        }
        return false;
    }
    ...
    public boolean delete(String whereClause, String[] whereArgs) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " delete");
        }
        return false;
    }
    ...
    public boolean deleteList(List<Pair<String, String[]>> where) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " deleteList");
        }
        return false;
    }
    ...
    public boolean replace(T t) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " replaceT");
        }
        return false;
    }
    ...
    public boolean replace(ContentValues contentValues) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " replaceContentValues");
        }
        return false;
    }
    ...
    public boolean replace(List<T> ts) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " replaceList");
        }
        return false;
    }
    ...
    public boolean update(T t, String whereClause, String[] whereArgs) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " updateT");
        }
        return false;
    }
    ...
    public boolean update(ContentValues contentValues, String whereClause, String[] whereArgs) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " updateContentValues");
        }
        return false;
    }
    ...
    public T queryOne(String selection, String[] selectionArgs) {
        ...
        HLogF.v(TAG, System.currentTimeMillis() - start + " queryOne");
    ...
    public List<T> query(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy, String limit) {
        ...
        try {
            ...
            database.endTransaction();
            lock.unlock();
            HLogF.v(TAG, System.currentTimeMillis() - start + " query");
        }
        return list;
    }
