...
//    });
    ...
    public static void v(String tag, String msg) {
        ...
        formatOutPutLog(LEVEL_V, tag, msg, null);
    }
    ...
    public static void v(String tag, String msg, Throwable tr) {
        ...
        formatOutPutLog(LEVEL_V, tag, msg, tr);
    }
    ...
    public static void i(String tag, String msg) {
        ...
        formatOutPutLog(LEVEL_I, tag, msg, null);
    }
    ...
    public static void d(String tag, String msg) {
        ...
        formatOutPutLog(LEVEL_D, tag, msg, null);
    }
    ...
    public static void d(String tag, String msg, Throwable tr) {
        ...
        formatOutPutLog(LEVEL_D, tag, msg, tr);
    }
    ...
    public static void w(String tag, String msg) {
        ...
        formatOutPutLog(LEVEL_W, tag, msg, null);
    }
    ...
    public static void w(String tag, String msg, Throwable tr) {
        ...
        formatOutPutLog(LEVEL_W, tag, msg, tr);
    }
    ...
    public static void e(String tag, String msg) {
        ...
        formatOutPutLog(LEVEL_E, tag, msg, null);
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        ...
        formatOutPutLog(LEVEL_E, tag, msg, tr);
    }
        ...
        mExecutor.execute(new FutureTask<Void>(new Callable<Void>() {
            ...
            public Void call() throws Exception {
                if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                    ...
                    String userDirPath = Constant.DIR_PUBLIC_ROOT + "/log/";
    ...
    private static void formatOutPutLog(String logType, String tag, String msg, Throwable t) {
        int length = msg.length();
        if (length > 4000) {
            log(logType, tag, msg.substring(0, 4000), t);
            formatOutPutLog(logType, tag, msg.substring(4000, msg.length()), t);
        } else {
