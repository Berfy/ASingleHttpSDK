...
import cn.berfy.sdk.http.http.okserver.upload.UploadTask;
import cn.berfy.sdk.http.http.okserver.upload.UploadThreadPool;
...
public class OkUpload {
    ...
    private final String TAG = Constant.HTTPTAG + "_OkUpload";
