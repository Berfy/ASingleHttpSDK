 ...
 */
package cn.berfy.sdk.http.http.okgo.adapter;

import cn.berfy.sdk.http.http.okgo.cache.CacheEntity;
import cn.berfy.sdk.http.http.okgo.cache.policy.CachePolicy;
import cn.berfy.sdk.http.http.okgo.cache.policy.DefaultCachePolicy;
import cn.berfy.sdk.http.http.okgo.cache.policy.FirstCacheRequestPolicy;
import cn.berfy.sdk.http.http.okgo.cache.policy.NoCachePolicy;
import cn.berfy.sdk.http.http.okgo.cache.policy.NoneCacheRequestPolicy;
import cn.berfy.sdk.http.http.okgo.cache.policy.RequestFailedCachePolicy;
