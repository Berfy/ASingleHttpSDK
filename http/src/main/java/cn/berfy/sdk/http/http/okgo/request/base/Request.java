 ...
 */
package cn.berfy.sdk.http.http.okgo.request.base;
...
import cn.berfy.sdk.http.http.okgo.adapter.AdapterParam;
import cn.berfy.sdk.http.http.okgo.adapter.CacheCall;
import cn.berfy.sdk.http.http.okgo.adapter.Call;
import cn.berfy.sdk.http.http.okgo.adapter.CallAdapter;
import cn.berfy.sdk.http.http.okgo.cache.CacheEntity;
import cn.berfy.sdk.http.http.okgo.cache.CacheMode;
import cn.berfy.sdk.http.http.okgo.cache.policy.CachePolicy;
import cn.berfy.sdk.http.http.okgo.callback.Callback;
import cn.berfy.sdk.http.http.okgo.convert.Converter;
import cn.berfy.sdk.http.http.okgo.model.HttpHeaders;
import cn.berfy.sdk.http.http.okgo.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Request(String url) {
        ...
        //默认添加 User-Agent
        String userAgent = HttpHeaders.getUserAgent(go.getContext());
